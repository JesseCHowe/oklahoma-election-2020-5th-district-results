...
const colorScale = d3.scale
  ...
  option1 = "STEVE RUSSELL",
  option2 = "KENDRA HORN",
  electionData =
    "https://gist.githubusercontent.com/JesseCHowe/6e1bc42e963503bf99806a84ed35670f/raw/8c97ff87bfbb1d758a3060121988ebb1c352b2df/test3.csv";
...
function loaded(error, county, us, results, places) {
  us.objects.tl_2019_us_county.geometries = us.objects.tl_2019_us_county.geometries.filter(
    (o) => {
      if (
        o.properties.NAME === "Oklahoma" ||
        o.properties.NAME === "Pottawatomie" ||
        o.properties.NAME === "Seminole"
      ) {
        return o.properties.NAME;
      }
    }
  );
  county.objects.pct_2010.geometries = county.objects.pct_2010.geometries.filter(
    (o) => {
      if (
        o.properties.COUNTY_NAM === "OKLAHOMA" ||
        o.properties.COUNTY_NAM === "POTTAWATOMIE" ||
        o.properties.COUNTY_NAM === "SEMINOLE"
      ) {
        return o;
      }
    }
  ...
  function getColorElection(d) {
    ...
    const testnumer = test.filter((o) => o.cand_name == option1)[0] || 0;
